...
public class NewMsgActivity extends Activity implements NewMsgContract.View {
    ...
    public void onClick() {
        ...
        ClientService.sendEncryptedMessage(conversation.getInterlocutor().getContactKeys().get(0).getKeyBase64(), realm.where(AccountEntity.class).equalTo("active", true).findFirst().getKeyBase64(), newMessage);
