...
public class AccountManager {
    ...
    public boolean deleteAccount(String name) {
        ...
        Log.v(getClass().getSimpleName(), "DELETING ACCOUNT " + name);
        Log.v(getClass().getSimpleName(), realm.where(Account.class).findAll().toString());
    ...
    public void signUp(final Account account) {
        ...
        Log.v(getClass().getSimpleName(), "Sign up call to : " + call.request().url());
        Log.v(getClass().getSimpleName(), "Sign up method : " + call.request().method());
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                Log.v(getClass().getSimpleName(), "Sign up response: " + response.message());
                Log.v(getClass().getSimpleName(), "Sign up response code: " + response.code());
                ...
                if (response.isSuccessful()) {
                    ...
                    realm.commitTransaction();
                    Log.v(getClass().getSimpleName(), "Account " + account.getName() + " registered");
                }
            }
    ...
    private String requestCode() {
        ...
        try {
            ...
            Log.v(getClass().getSimpleName(), "request code url " + requestCodeCall.request().url());
            ...
            Log.v(getClass().getSimpleName(), "Fetched code " + codeCallResponse.body());
            Log.v(getClass().getSimpleName(), "Fetching status " + codeCallResponse.code());
    ...
    public String logIn() {
        ...
        try {
            ...
            Log.v(getClass().getSimpleName(), "login call code:" + loginCallResponse.code());
            ...
            Log.v(getClass().getSimpleName(), "Cookie " + cookie);
            ...
            Log.v(getClass().getSimpleName(), "Login successful");
            realm.close();
            return cookie;
    ...
    public String getOneTimeKey(String keyBase64) throws InvalidKeyException, IOException {
        ...
        Log.v(getClass().getSimpleName(), "request code url " + getOneTimeKeyCall.request().url());
        ...
        Log.v(getClass().getSimpleName(), "Fetched code " + getOneTimeKeyCallResponse.body());
        Log.v(getClass().getSimpleName(), "Fetching status " + getOneTimeKeyCallResponse.code());
    ...
    public String getSignedKey(String keyBase64) throws InvalidKeyException, IOException {
        ...
        Log.v(getClass().getSimpleName(), "request code url " + getSignedKeyCall.request().url());
        ...
        Log.v(getClass().getSimpleName(), "Fetched code " + getSignedKeyCallResponse.body());
        Log.v(getClass().getSimpleName(), "Fetching status " + getSignedKeyCallResponse.code());
    ...
    public String postOneTimeKeys() throws IOException {
        ...
        if (activeAcc.getOneTimeKeys() == null || activeAcc.getOneTimeKeys().isEmpty()) {
            Log.d(getClass().getSimpleName(), "There are no one time keys to be fetched");
            return null;
        }
        ...
        Log.v(getClass().getSimpleName(), "post one time keys call code:" + postOneTimeKeysResponse.code());
        Log.v(getClass().getSimpleName(), "post one time keys call keys:" + Arrays.toString(otkeysTO.toArray()));
        Log.v(getClass().getSimpleName(), "post one time keys call url:" + postOneTimeKeysCall.request().url());

        for (String name : postOneTimeKeysResponse.headers().names()) {
            Log.v(getClass().getSimpleName(), name + " : " + postOneTimeKeysResponse.headers().get(name));
        }

        if (!postOneTimeKeysResponse.isSuccessful()) {
            Log.v(getClass().getSimpleName(), "Failed to post one time keys");
            return null;
        }

        Log.v(getClass().getSimpleName(), "PostOneTimeKeys successful");
        realm.close();
        return "Success";
    }
    ...
    public String postSignedKey() throws IOException {
        ...
        if (active.getSignedKey() == null) {
            Log.d(getClass().getSimpleName(), "There are no signed keys to be fetched");
            return null;
        }
        ...
        Log.v(getClass().getSimpleName(), "post signed keys call code:" + postSignedKeysResponse.code());
        Log.v(getClass().getSimpleName(), "post signed keys call url:" + postSignedKeysCall.request().url());

        for (String name : postSignedKeysResponse.headers().names()) {
            Log.v(getClass().getSimpleName(), name + " : " + postSignedKeysResponse.headers().get(name));
        }

        if (!postSignedKeysResponse.isSuccessful()) {
            Log.v(getClass().getSimpleName(), "Failed to post signed keys");
            return null;
        }

        realm.close();
        Log.v(getClass().getSimpleName(), "PostSignedKeys successful");
        return "Success";
    }
